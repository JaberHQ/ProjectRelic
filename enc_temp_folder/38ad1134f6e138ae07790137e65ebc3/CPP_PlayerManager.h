...
private:
	...
	float m_acceptableRadiusToEnemy; // Acceptable distance for enemy takedown
	float m_chanceOfHit; // Chance to take damage
	float m_takedownTraceValue; // End of takedown trace
	...
	TArray<UMaterialInterface*> m_material; // Player material array
...
public:
	...
	*****************************************************************************/
	...
	/*****************************************************************************
	  ...
	  *****************************************************************************/
	UFUNCTION( BlueprintCallable )
		bool GetDeathHitmarkerActive() const;
	/*****************************************************************************
